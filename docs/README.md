...
Use `plans/README.md` at the repository root to find current execution plans
...
`research/soccer_modeling_public_research_2026-05-26.md` (public soccer
modeling literature review).

For package-level documentation, see `CLAUDE.md`, `nwsl-model/README.md`, and
