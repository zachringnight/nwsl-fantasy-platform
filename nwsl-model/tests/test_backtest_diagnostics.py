...
def test_summarize_gate_blockers_reports_target_shortfalls() -> None:
        ...
        "gate_results": {
            "dixon_coles": {
                ...
                "metrics": {
                    ...
                    "totals_brier_3.5": 0.2555,
                    "max_classwise_ece": 0.0575,
                    "totals_ece": 0.0672,
    ...
    rows = summarize_gate_blockers(
        promotion,
        relative_improvement=0.98,
        totals_brier_gate=0.24,
    )
    ...
    assert rows == [
        {
            ...
            "gating_status": "research_only",
            "failed_checks": (
                "beats_best_baseline_log_loss,totals_brier_ok,"
                "classwise_ece_ok,totals_ece_ok"
            ),
            ...
            "totals_brier_3_5_target": 0.24,
            "totals_brier_3_5_shortfall": 0.0155,
            "classwise_ece_target": 0.05,
            "classwise_ece_shortfall": 0.0075,
            "totals_ece_target": 0.06,
            "totals_ece_shortfall": 0.0072,
