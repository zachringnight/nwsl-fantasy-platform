          ...
          {(resetState === "ready" || resetState === "submitting") && (
            <form className="space-y-4" onSubmit={handleSubmit}>
              <label className="block space-y-2">
                ...
                />
                {password.length > 0 && (
                  <p id="password-strength" className={`text-xs ${password.length >= 10 ? "text-brand-lime" : password.length >= 8 ? "text-warning" : "text-danger"}`}>
                    {password.length < 8 ? "Too short" : password.length < 10 ? "Acceptable — add more characters for better security" : "Strong password"}
                  </p>
                )}
              </label>
              <label className="block space-y-2">
          ...
          <div className="space-y-3">
            <div className="rounded-[1.2rem] border border-line bg-white/6 p-4 text-sm leading-6 text-foreground">
              ...
              <p className="mt-2 text-muted">
                At least 8 characters. Mix letters, numbers, and symbols for the best protection.
              </p>
            </div>
            <div className="rounded-[1.2rem] border border-line bg-white/6 p-4 text-sm leading-6 text-foreground">
